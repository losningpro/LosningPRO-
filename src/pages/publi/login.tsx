...
export default function LoginPage() {
  ...
  async function handleEmailLogin(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Log ind mislykkedes. Prøv igen.";
      setError(message);
    } finally {
      setSubmitting(false);
    }
  ...
  async function handleOAuthLogin(provider: "google" | "facebook") {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Social login mislykkedes. Prøv igen.";
      setError(message);
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={isBusy}
              className="flex w-full items-center justify-center rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-800 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
            >
