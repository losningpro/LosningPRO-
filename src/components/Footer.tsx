...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-brand to-brand/80 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="space-y-3 text-white/90">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+45452717810" className="hover:text-white transition-colors">
                  +45 52 71 78 10
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@losningpro.dk" className="hover:text-white transition-colors">
                  info@losningpro.dk
                </a>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/85">
              ...
              <li>
                <Link to="/erhverv" className="hover:text-white transition-colors">
                  Erhverv
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/85">
              <li>
                <Link to="/tjenester" className="hover:text-white transition-colors">
                  Tjenester & priser
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/juridisk-information" className="hover:text-white transition-colors">
        ...
        <div className="border-t border-white/20 mt-10 pt-8 text-center text-white/75">
          <p>
            ...
            <Link to="/juridisk-information" className="underline hover:text-white transition-colors">
